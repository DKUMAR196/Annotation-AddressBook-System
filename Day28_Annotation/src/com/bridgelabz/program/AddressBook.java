...
public class AddressBook {
    ...
    public void addContact(AddressBook addressBook) {
        ...
        try {
            PrintWriter printWriter = new PrintWriter("C:\\Users\\deepa\\OneDrive\\Documents\\Address.txt");
            printWriter.println(addressBook.list);
        }catch (Exception e ){
            System.out.println(e.getMessage());
        }
        try {
            BufferedWriter br = new BufferedWriter(new FileWriter("C:\\Users\\deepa\\OneDrive\\Documents\\Address.json"));
            Gson gson = new Gson();
            gson.toJson(list,br);
            br.close();
        }catch (IOException e){
        ...
        try {
            FileWriter fileWriter = new FileWriter("C:\\Users\\deepa\\OneDrive\\Documents\\Address.csv");
    ...
    public void readCSVFile () {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\deepa\\OneDrive\\Documents\\address.csv"));
    ...
    private void readAddressBook() {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\deepa\\OneDrive\\Documents\\Address.txt"));
            String line = " ";
            while (line != null){
